...
INCLUDES = -I include -I include/GLFW -I include/soloud -I src/imgui -I src
LIBS = -L./lib -lglfw3dll -lglfw3 -lopengl32 -lbox2d -lws2_32 -liphlpapi -lsoloud_static -lwinmm
